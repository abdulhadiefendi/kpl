<form action="<?= base_url('storepegawai') ?>" method="post">
  <div class="form-group">
    <label for="nama">Nama Lengkap</label>
    <input type="text" class="form-control" id="nama" aria-describedby="namafail" placeholder="Nama Lengkap" name="nama" value="<?= set_value('nama'); ?>">
    <small id="namafail" class="form-text text-danger"><?= form_error('nama'); ?></small>
  </div>
  <div class="form-group">
    <label for="email">Email</label>
    <input type="email" class="form-control" id="email" aria-describedby="emailfail" placeholder="Email" name="email" value="<?= set_value('email'); ?>">
    <small id="emailfail" class="form-text text-danger"><?= form_error('email'); ?></small>
  </div>
  <div class="form-group">
    <label for="username">Username</label>
    <input type="text" class="form-control" id="username" aria-describedby="usernamefail" placeholder="Username" name="username" value="<?= set_value('username'); ?>">
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" id="password" aria-describedby="passwordfail" placeholder="Password" name="password" value="<?= set_value('password'); ?>">
