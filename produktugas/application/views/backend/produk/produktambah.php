<form action="<?= esc_attr(base_url('storeproduk')) ?>" method="post" enctype="multipart/form-data">
 ...
 <div class="row">
 	 <div class="form-group col-md-4">
	    ...
	    <input type="text" class="form-control" id="warna" aria-describedby="warnafail" placeholder="Warna" name="warna" value="<?= esc_html(set_value('warna')); ?>">
	    <small id="warnafail" class="form-text text-danger"><?= esc_html(form_error('warna')); ?></small>
	  </div>
	  <div class="form-group col-md-4">
	    <label for="ukuran">Ukuran</label>
	    <input type="text" class="form-control" id="ukuran" aria-describedby="ukuranfail" placeholder="Ukuran" name="ukuran" value="<?= esc_html(set_value('ukuran')); ?>">
	    <small id="ukuranfail" class="form-text text-danger"><?= esc_html(form_error('ukuran')); ?></small>
	  </div>
	  <div class="form-group col-md-4">
	    <label for="harga">Harga</label>
	    <input type="number" class="form-control" id="harga" aria-describedby="hargafail" placeholder="Harga" name="harga" value="<?= esc_html(set_value('harga')); ?>">
 ...
 <div class="form-group">
    ...
    <input type="file" class="form-control" id="gambar" aria-describedby="gambarfail" placeholder="gambar" name="gambar" value="<?= esc_html(set_value('gambar')); ?>">
    <small id="gambarfail" class="form-text text-danger"><?= esc_html(form_error('gambar')); ?></small>
  </div>

  <div class="form-group">
    <label for="deskripsi">Deskripsi</label>
    <textarea name="deskripsi" id="deskripsi" cols="30" rows="7" class="form-control" aria-describedby="deskripsifail" placeholder="Deskripsi"><?= esc_html(set_value('deskripsi')); ?></textarea>
